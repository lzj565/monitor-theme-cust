...
function Tile({ icon: Icon, label, children, tone }: {
  ...
  return (
    <Card className="min-h-[7rem] gap-0 p-3">
    ...
    <div className="grid grid-cols-1 gap-3 min-[480px]:grid-cols-2 lg:grid-cols-4">
      <Tile icon={Server} label="节点状态" tone="text-metric-cyan">
        <div className="mt-1.5 flex items-center justify-between gap-3">
          ...
          <div className="tnum shrink-0 text-sm font-semibold text-ok">{onlineRate.toFixed(0)}%</div>
        </div>
        <div
        ...
        <div className="tnum mt-1.5 grid grid-cols-2 gap-x-3 text-xs">
      ...
      <Card className="min-h-[7rem] gap-0 p-3">
        <div className="tnum grid h-full grid-cols-2 grid-rows-[auto_1fr] gap-x-3">
          ...
          <div className="flex min-w-0 items-center pt-1.5">
            <Flow
